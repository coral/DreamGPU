...
"""Run the production driver transaction and Win32 adapter under sanitizers."""
import os
...
with tempfile.TemporaryDirectory(prefix='dreamgpu-driver-lifecycle-') as directory:
