...
/* Context-free virtual display timing; independent of host presentation. */
#define DG_TIMING_REG_VERSION 0x1048
#define DG_TIMING_REG_RATES 0x104c
#define DG_TIMING_REG_RATE 0x1050
#define DG_TIMING_REG_SNAPSHOT 0x1054
#define DG_TIMING_REG_SERIAL 0x1058
#define DG_TIMING_REG_SCANLINE 0x105c
#define DG_TIMING_REG_HEIGHT 0x1060
#define DG_TIMING_REG_PHASE 0x1064
#define DG_TIMING_REG_BEGIN_NS 0x1068
#define DG_TIMING_REG_END_NS 0x106c
#define DG_TIMING_REG_SEQUENCE 0x1070
#define DG_TIMING_REG_COMMAND 0x1074
#define DG_TIMING_REG_COMPLETED 0x1078
#define DG_TIMING_REG_STATUS 0x107c
#define DG_TIMING_VERSION 1
#define DG_TIMING_RATES 0x1f
#define DG_TIMING_DEFAULT_HZ 60
#define DG_TIMING_CANCEL 0
#define DG_TIMING_WAIT_BEGIN 1
#define DG_TIMING_WAIT_END 2
#define DG_TIMING_IDLE 0
#define DG_TIMING_PENDING 1
#define DG_TIMING_DONE 2
#define DG_TIMING_CANCELLED 3
#define DG_TIMING_BLANK_LINES 20
#define DG_CAP_DISPLAY_TIMING 0x40
#define DG_IRQ_DISPLAY_TIMING 0x04
